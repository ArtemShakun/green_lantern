...
class Cat:
    ...
    def _set_average_speed(self):
        if self.age <= 7:
            return 12
        elif self.age > 7 and self.age < 11:
            return 9
        elif self.age > 10:
            return 6
    ...
    def run(self, hours):
        ...
        return f"Your cat ran {self.saturation_level} kilometers"
...
class Cheetah(Cat):
    ...
    def _set_average_speed(self):
        if self.age <= 5:
            return 90
        elif self.age > 5 and self.age < 16:
            return 75
        elif self.age > 15:
            return 40
...
class Wall:
    ...
    +* Implement method number_of_rolls_of_wallpaper which receives such parameters: roll_width_m, roll_length_m
     ...
     + Example:
          ...
          1.count of lines in roll eq roll length in meters divide height of the wall (use rounding down)
          2. count of lines eq width of the wall divide roll width in meters
          3. number of rolls of wallpaper eq count of lines divide  count of lines in roll
    ...
    def number_of_rolls_of_wallpaper(self, roll_width_m, roll_length_m):
        ...
        count_line_roll = roll_length_m / self.height
        count_roll = count_lines / count_line_roll
        return count_roll
...
class Door:
    ...
    def update_wood_price(self, new_wood_price):
        self._wood_price = self.new_wood_price
        return self._wood_price

    def update_metal_price(self, new_metal_price):
        self._metal_price = self.new_metal_price
        return self._metal_price
...
class House:
    ...
    def get_walls_square(self):
        ...
        for wall in self.__walls:
            suma_all_walls = suma_all_walls + wall.wall_square()
        return suma_all_walls

    def get_windows_square(self):
        suma_all_windows = 0
        for window in self.__windows:
            suma_all_windows = suma_all_windows + window.window_square()
        return suma_all_windows
    ...
    def get_number_of_rolls_of_wallpapers(self, roll_width_m, roll_length_m):
        if roll_width_m == 0 or roll_length_m == 0:
            ...
            for wall in self.__walls:
                ...
                rolls_all_walls += rolls_of_wallpaper
            return rolls_all_walls
