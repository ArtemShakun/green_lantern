...
class City(models.Model):
    name = models.CharField(unique=True, max_length=50)
    id_country = models.ForeignKey(Country, models.DO_NOTHING)
...
class Restoran(models.Model):
    ...
    id_menu = models.ForeignKey(Menu, models.DO_NOTHING)
...
class Personnel(models.Model):
    ...
    id_restoran = models.ForeignKey(Restoran, models.DO_NOTHING)
